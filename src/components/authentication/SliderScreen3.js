        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    {/* <Image source={require('../../commons/images/heading3.png')} />
                    <Image source={require('../../commons/images/subheading2.png')} /> */}
                    <Text style={{fontSize:30,fontWeight:'bold',color:'#1D3557'}}>Keep your goal</Text>
                    <Text style={{fontSize:30,fontWeight:'bold',color:'#1D3557'}}>achiever</Text>
                ...
                <View style={{ justifyContent: 'center', marginBottom: 20, marginHorizontal: 20, marginTop: 80 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        <TouchableOpacity activeOpacity={0.5} onPress={this.goLogin}>
