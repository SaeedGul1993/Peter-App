...
export default class SplashScreen extends Component {
    ...
    gonext = () => {
        this.props.navigation.navigate('SliderScreen2')
    }
        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    {/* <Image source={require('../../commons/images/heading1.png')} />
                    <Image source={require('../../commons/images/subheading1.png')} /> */}
                    <Text style={{fontSize:30,fontWeight:'bold',color:'#1D3557'}}>Manage</Text>
                    <Text style={{fontSize:30,fontWeight:'bold',color:'#1D3557'}}>your goal easily</Text>
                    <Text style={{fontSize:13,color:'#000000'}}>Easy way to pursue your goals and task</Text>
                    <Text style={{fontSize:13,color:'#000000'}}>management</Text>
                </View>
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    <Image source={require('../../commons/images/slider1.png')} resizeMode='contain' />
                </View>
