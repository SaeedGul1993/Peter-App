                ...
                <View style={{marginHorizontal:20,marginVertical:20}}>
                    ...
                    <View>
                        <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
                            ...
                            <Text style={{fontSize:18,color:'#10275A'}}>Detail</Text>
                        ...
                        <View style={{backgroundColor:'',borderRadius:10,marginVertical:10}}>
                            ...
                            <View style={{marginTop:20}}>
                                ...
                                <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between',marginTop:5}}>
                                    ...
                                    <View style={{alignItems:'center',justifyContent:'center',backgroundColor:'#e8e8e8',width:'35%',paddingVertical:8,borderTopRightRadius:20,borderBottomRightRadius:20}}>
                                        <Text style={{fontSize:14,color:'#10275A'}}>3 days remaining</Text>
                                    </View>
