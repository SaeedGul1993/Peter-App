                ...
                <View style={{ marginHorizontal: 20, marginVertical: 20 }}>
                    ...
                    <View>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                            ...
                            <Text style={{ fontSize: 18, color: '#10275A', fontWeight: 'bold' }}>My Offer & Notification</Text>
                            <View style={{ width: 30 }} />
                        </View>
                        ...
                        <ScrollView style={{ marginBottom: 80 }} showsVerticalScrollIndicator={false}>
                                ...
                                <View style={{ width: '70%', alignSelf: 'center', backgroundColor: '', marginVertical: 10, borderRadius: 10 }}>
                                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', height: 45 }}>
                                        ...
                                        <TouchableOpacity activeOpacity={0.5} onPress={() => this._pending(true)}
                                            ...
                                            <Text style={{ fontSize: 17, color: pending ? '#648CFF' : '#10275A' }}>My Offer</Text>
                                        </TouchableOpacity>
                                        <TouchableOpacity activeOpacity={0.5} onPress={() => this._pending(false)}
                                            ...
                                            <Text style={{ fontSize: 17, color: pending ? '#10275A' : '#648CFF' }}>Notifications</Text>
                                        </TouchableOpacity>
                                    </View>
                                </View>
                            </View>
                            ...
                            <TouchableOpacity activeOpacity={0.5}
                                style={{ backgroundColor: '#E5E5E5', borderColor:'#648CFF', borderWidth: 1, borderRadius: 10, marginVertical: 10 }}>
                                <View style={{ flexDirection: 'row', alignItems: 'center', marginHorizontal: 10, marginVertical: 20 }}>
                                    <Text style={{ width: 3, height: 70, backgroundColor: '#648CFF' }}></Text>
                                    <View style={{ width: '95%' }}>
                                        ...
                                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', marginTop: 10 }}>
                                            <Text style={{ fontSize: 14, color: '#10275A', marginLeft: 20 }}>Invitation from Facebook</Text>
                                        </View>
                                    </View>
                                    {/* <Icon1 name='dot-single' size={25} /> */}
                                    <View style={{height:15,width:15,borderRadius:15/2, backgroundColor:'#648CFF'}} />
                                </View>
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity activeOpacity={0.5}
                                ...
                                <View style={{ flexDirection: 'row', alignItems: 'center', marginHorizontal: 10, marginVertical: 20 }}>
                                    ...
                                    <View style={{ width: '95%' }}>
                                        ...
                                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', marginTop: 10 }}>
                                            <Text style={{ fontSize: 14, color: '#10275A', marginLeft: 20 }}>Friend Challenge Reminder</Text>
                                        </View>
                                    </View>
                                    {/* <Icon1 name='dot-single' size={25} /> */}
                                    <View style={{height:15,width:15,borderRadius:15/2, backgroundColor:'#648CFF'}} />
                            ...
                            <TouchableOpacity activeOpacity={0.5}
                                ...
                                <View style={{ flexDirection: 'row', alignItems: 'center', marginHorizontal: 10, marginVertical: 20 }}>
                                    ...
                                    <View style={{ width: '95%' }}>
                                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginLeft: 20 }}>
                                            <Text style={{ fontSize: 15, color: '#10275A' }}>Got reward of Todo Completition</Text>
                                        </View>
                                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', marginTop: 10 }}>
                                            <Text style={{ fontSize: 14, color: '#10275A', marginLeft: 20 }}>Free 20 points</Text>
                                        </View>
                                    </View>
                                    {/* <Icon1 name='dot-single' size={25} /> */}
                                    <View style={{height:15,width:15,borderRadius:15/2, backgroundColor:'#648CFF'}} />
